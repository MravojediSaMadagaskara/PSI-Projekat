...
class IgraDemo extends CI_Controller {
	...
	public function index() {
		...
		$korisnik = $em->find("Entity\Korisnik", 1);
		...
		$this->load->view('igrademo', $podaci);
	...
	public function izaberiPitanje() {
		...
		$pitanje = $em->find("Entity\Pitanje", 1);
	...
	public function osveziPitanje() {
		...
		$pitanje = $result[$_POST['redniBroj']];
